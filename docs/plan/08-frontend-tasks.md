...
>
> **디자인 기준: `13-design-guide.md` 필독.** 시안 미확정 상태의 기준은 목업(`docs/images/dashboard-mockup.png`/
> `docs/images/widget-mockup.png`, 13 문서에서는 image-1/image-2로 지칭)이며, 13 문서 §2의 교정표(지니계수 라벨 금지, 사용액→건수 등)를
...
- [x] ~~`CardItem`~~ → **`ProposalSummary` + `RankTrace`로 대체됨** (2026-08-06 허브 리디자인, 18 문서).
      허브 목록용: 제목, 정량 순위→AI 조정 순위(`Score 2위 → AI 제안 1위` 강조 표기),
      신뢰도, 승인/반려/보류 버튼
