...
const DATASETS: Dataset[] = [
  ...
  },
  {
    ...
    agency: "(주)강원랜드 · 공공데이터포털",
    kind: "오픈 API",
    href: "https://www.data.go.kr/data/15148364/openapi.do",
  ...
  },
  {
    ...
    kind: "오픈 API",
    href: "https://www.data.go.kr/data/15012005/openapi.do",
  ...
  },
  {
    ...
    agency: "국세청 · 공공데이터포털",
    kind: "파일데이터 (CSV)",
    // CSV가 2종(존속연수별·100대 생활업종)이라 단일 상세 페이지로 특정되지 않는다 — 목록 검색을 건다
    href: "https://www.data.go.kr/tcs/dss/selectDataSetList.do?keyword=%EA%B5%AD%EC%84%B8%EC%B2%AD_%EC%82%AC%EC%97%85%EC%9E%90%ED%98%84%ED%99%A9",
