...
def demo_cards() -> list:
    ...
    card_b = {
        ...
        "ai": {
            "adjusted": True,
            "comparison": (
                "1순위(조정) 영월군 소매점 강원선바위협동조합: Score 2위(0.65)로 1위와 0.02 차이인 "
                "데다, 추진중인 영월군 카페 확충(문갤러리)과 업종이 겹치지 않고 같은 영월 상동 방면 "
                "관광동선에 있어 동반 홍보 시너지가 예상되며 즉시 착수 가능. "
                "2순위(Score 1위) 영월군 숙박업 동빈네민박&캠핑장(0.67): 숙박업 특성상 가맹 협상·"
                "시설 확인에 시간이 걸릴 가능성이 있어 여름 성수기 내 효과 확인이 어려울 수 있음."),
            "reasons": [
                "추진중인 영월군 카페 확충 카드(문갤러리)와 업종이 겹치지 않아 중복 착수 위험이 없고, 같은 상동 방면 관광동선이라 동반 홍보 시너지 예상",
                "Score 1위 숙박업 후보(0.67)와의 격차가 0.02로 근소한 반면, 소매점은 여름 성수기(휴가철·워터월드) 수요에 즉시 대응 가능할 것으로 예상",
